...
* [OBDium](https://github.com/provrb/obdium) - Vehicle diagnostics app for live OBD-II data, fault code analysis, and offline VIN decoding over ELM327 adapters.
...
* [CANopenTerm](https://github.com/CANopenTerm/CANopenTerm) - Tool for developing, testing and analyzing CANopen CC & CAN CC networks and devices.
...
* [CANvenient](https://github.com/CANopenTerm/CANvenient) - An abstraction layer for multiple CAN APIs on Windows and Linux.
